...
$(info Makefile: KIT_XMC72_EVK)

    # Default
    OTA_FLASH_MAP?=$(RELATIVE_FILE1_FILE2)/../configs/flashmap/xmc7200_int_swap_single.json
    OTA_PLATFORM_CONFIG_JSON=$(RELATIVE_FILE1_FILE2)/../configs/flashmap/xmc7200_platform.json
...
$(info Makefile: OTA_BT_ONLY=1         IGNORE WiFi libraries)
    ...
    CY_IGNORE+=$(SEARCH_ethernet-connection-manager)
    CY_IGNORE+=$(SEARCH_ethernet-core-freertos-lwip-mbedtls)
...
$(info Makefile: *NO* OTA_BT_ONLY IGNORE BT  libraries)
    ...
    INCLUDES+=$(SEARCH_aws-iot-device-sdk-embedded-C)/libraries/aws/ota-for-aws-iot-embedded-sdk/source/include
...
ifeq ($(OTA_BUILD_VERBOSE),1)
$(info Makefile: XMC7200 IGNORE serial-flash libraries)
endif
# Ignore other libraries that XMC7200 will not use
    CY_IGNORE+=$(SEARCH_serial-flash)
    CY_IGNORE+=$(SEARCH_wifi-connection-manager)
    CY_IGNORE+=$(SEARCH_wifi-core-freertos-lwip-mbedtls)
    CY_IGNORE+=$(SEARCH_whd-bsp-integration)
    CY_IGNORE+=$(SEARCH_wifi-host-driver)
    CY_IGNORE+=$(SEARCH_wpa3-external-supplicant)
    CY_IGNORE+=$(SEARCH_cy_mbedtls_acceleration)
endif
