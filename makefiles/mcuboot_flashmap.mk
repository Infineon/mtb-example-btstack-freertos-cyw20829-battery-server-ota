    ...
    ifneq ($(findstring $(MAKECMDGOALS), build program all),)
        ...
        ifeq ($(OTA_PLATFORM),XMC7200)
            ...
            ifneq ($(FLASHMAP_PYTHON_SCRIPT),)
                ...
                $(info "flashmap_xmc.py $(CY_PYTHON_PATH) $(RELATIVE_FILE1_FILE2)/../scripts/$(FLASHMAP_PYTHON_SCRIPT) run -p $(OTA_PLATFORM_CONFIG_JSON) -i $(OTA_FLASH_MAP) -o $(RELATIVE_FILE1_FILE2)/../ -n flashmap -d $(IMG_ID) > flashmap.mk")
                $(shell $(CY_PYTHON_PATH) $(RELATIVE_FILE1_FILE2)/../scripts/$(FLASHMAP_PYTHON_SCRIPT) run -p $(OTA_PLATFORM_CONFIG_JSON) -i $(OTA_FLASH_MAP) -o $(RELATIVE_FILE1_FILE2)/../ -n flashmap -d $(IMG_ID) > flashmap.mk)
...
$(info Makefile: XMC7200 POSTBUILD )
    ...
    MCUBOOT_XMC_SCRIPT_FILE_PATH?=$(RELATIVE_FILE1_FILE2)/../scripts/sign_script_xmc7200.bash
    CY_ELF_TO_HEX=$(CY_HEX_TO_BIN)
